...
namespace CarBook.WebApi.Controllers
{
    ...
    public class BlogsController : ControllerBase
    {
        ...
        [HttpGet("GetLastThreeBlogsWithAuthorsQuery")]
        public async Task<IActionResult> GetLastThreeBlogsWithAuthorsQuery()
        {
            var value = await _mediator.Send(new GetLastThreeBlogsWithAuthorsQuery());
            return Ok(value);
        }
